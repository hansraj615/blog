...
@section('content')
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Sub Create Gallery</li>
          </ol>
        </section>
          ...
          <div class="row">
            ...
            <div class="  col-md-6 ">
              ...
              <div class="box box-primary">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form method="POST"action="{{ route('gallery.store') }}" enctype="multipart/form-data" class="dropzone dropzone-custom needsclick add-professors dz-clickable">
                   
                  <input type="hidden" name="_token" value="{{ csrf_token() }}">
                  <div class="box-body">
                    <div class="form-group ">
                      <label for="galleryname">Name</label>
                    <input type="text" class="form-control is-valid {{($errors->first('galleryname') ? " form-error" : "form-valid")}}" id="galleryname" name="galleryname"  value="{{old('galleryname')}}" placeholder="Enter Gallery Category" autocomplete="off">
                    </div>
